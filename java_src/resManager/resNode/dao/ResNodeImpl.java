...
public class ResNodeImpl  extends SqlMapClientDaoSupport implements ResNodeDao {
	...
	public int addrectest(testframe fibercode){
		// TODO Auto-generated method stub
		this.getSqlMapClientTemplate().insert("addrectest", fibercode);
		return 1;
	};
	@Override
	public int modrectest(testframe fibercode){
		// TODO Auto-generated method stub
		this.getSqlMapClientTemplate().insert("modrectest", fibercode);
		return 1;
	};
	@Override
	public int delFibertest(String ocablename) {
		// TODO Auto-generated method stub
		return this.getSqlMapClientTemplate().delete("delFibertest", ocablename);
	}
	...
	public List gettestFiber(testframe fiber) {
		// TODO Auto-generated method stub
		return this.getSqlMapClientTemplate().queryForList("gettestfiber", fiber);
	}
	...
	public Integer getFiberCounttest(testframe fiber) {
		// TODO Auto-generated method stub
		return (Integer) this.getSqlMapClientTemplate().queryForObject("getfibercounttest", fiber);
	}
	/**
	 * 获取机盘信息
	 * */
