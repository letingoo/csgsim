...
public class SpringFactory implements FlexFactory
{
    ...
    static class SpringFactoryInstance extends FactoryInstance
    {
        ...
        {
            ApplicationContext appContext = WebApplicationContextUtils.getRequiredWebApplicationContext(flex.messaging.FlexContext.getServletConfig().getServletContext());
