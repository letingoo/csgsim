	...
	{     
		...
		{     
			...
			{   
				if (super.icon != null)
				{   
					myCheckBox.x = super.icon.x + myTree.checkBoxLeftGap + 10;     
					myCheckBox.y = (height - myCheckBox.height) / 2;  
					super.icon.x = myCheckBox.x + myCheckBox.width - 16;     
					super.label.x = super.icon.x + super.icon.width + 14;
				}
				else
				{     
				...
				var itemXml:XML = XML(super.data);
				if(itemXml){
					if(itemXml.@itemShowCheckBox == true){
