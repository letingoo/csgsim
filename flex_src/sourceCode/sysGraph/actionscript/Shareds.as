package sourceCode.sysGraph.actionscript
{
	...
	//liao
		public static var alla:Boolean=true;
		public static var sews:String = new String();
		public static var ses:String = new String();
		[Bindable]
		...
		[Bindable]
		public  static var stationdata:ArrayCollection = new ArrayCollection();   //liqinming
		[Bindable]
