...
//import sourceCode.tableResurce.model.ResultModel;
...
private function init():void
{
	...
	getCarryOperaN1(code, type, 0, this.pageSize);			//全部业务
	getCarryOperaN1Inf(code, type, 0, this.pageSizeInf);	//影响业务
	getCarryOperaN1Int(code, type, 0, this.pageSizeInt);	//中断业务
...
private function getCarryOperaN1(code:String, type:String, start:int, end:int):void
{
	...
	switch(type)
	{
		...
		case "ocable": getCarryOperaByTopolink(code, start, end); break;  //4, 从光缆查看N-1
