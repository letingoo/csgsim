package sourceCode.subject.main.actionscript.chart
{
    import com.encoder.*;
    ...
    public class FusionCharts extends UIComponent
    {
        ...
        public function FusionCharts() : void
        {
            ...
            xmlDATA = "";
            chartMessage = "";
            paramDATA = "<chart pieRadius='70' baseFontSize='12' pieSliceDepth='20'>";
        ...
        {
            errorData = chartType + ".swf file could not be found at the specified location. If you have specified custom path for chart SWF files, please make sure it is valid. Else, if you are using the default path (/FusionCharts1), please make sure that you\'ve copied the relevant chart SWF files in that folder.";
        ...
        private function exportHandler(event:FlashInterfaceEvent) : void
        {
            ...
            fileName = e.data.fileName != "" ? (e.data.fileName) : ("FusionCharts1");
        ...
        private function defaultData() : void
        {
            ...
            if (!isURLprovided)
            {
                ...
                if (chartType == "Radar")
                {
                    xmlDATA = "<chart pieRadius='70' caption=\'Product-wise sales\' subcaption=\'Comparison\' numberPrefix=\'$\'  chartRightMargin=\'40\' xAxisName=\'Product\' yAxisName=\'Revenue\' >" + "<categories>" + "<category label=\'Product A\' />" + "<category label=\'Product B\' />" + "<category label=\'Product C\' />" + "<category label=\'Product D\' />" + "<category label=\'Product E\' />" + "</categories>" + "<dataset seriesName=\'2008\'>" + "<set value=\'235000\' />" + "<set value=\'125100\' />" + "<set value=\'464200\' />" + "<set value=\'434500\' />" + "<set value=\'368500\' />" + "</dataset>" + "<dataset seriesName=\'2007\'>" + "<set value=\'198000\' />" + "<set value=\'409300\' />" + "<set value=\'253600\' />" + "<set value=\'345100\' />" + "<set value=\'42100\' />" + "</dataset>" + "<styles>" + "<definition>" + "<style type=\'font\' name=\'captionFont\' size=\'16\' />" + "</definition>" + "<application>" + "<apply toObject=\'caption\' styles=\'captionFont\' />" + "</application>" + "</styles>" + "</chart>";
                }
                ...
                {
                    xmlDATA = "<chart pieRadius='70' caption=\'Product-wise sales\' subcaption=\'Comparison\' numberPrefix=\'$\' chartRightMargin=\'40\' xAxisName=\'Product\' yAxisName=\'Revenue\' >" + "<categories>" + "<category label=\'Product A\' />" + "<category label=\'Product B\' />" + "<category label=\'Product C\' />" + "<category label=\'Product D\' />" + "</categories>" + "<dataset seriesName=\'2008\'>" + "<set value=\'235000\' />" + "<set value=\'125100\' />" + "<set value=\'464200\' />" + "<set value=\'434500\' />" + "</dataset>" + "<dataset seriesName=\'2007\'>" + "<set value=\'198000\' />" + "<set value=\'109300\' />" + "<set value=\'253600\' />" + "<set value=\'345100\' />" + "</dataset>" + "<styles>" + "<definition>" + "<style type=\'font\' name=\'captionFont\' size=\'16\' />" + "</definition>" + "<application>" + "<apply toObject=\'caption\' styles=\'captionFont\' />" + "</application>" + "</styles>" + "</chart>";
                }
        ...
        public function FCExportChart(... args) : void
        {
           // args = new activation;
            ...
            matrix = new Matrix();
            draw();
            fileName = length > 1 ? (args[1]) : ("FusionCharts1");
