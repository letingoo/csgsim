...
package common.other.gauges.brightPoint.controls
{
	
	import common.other.gauges.brightPoint.controls.gauge.GaugeSkin;
	import common.other.gauges.brightPoint.controls.gauge.events.GaugeEvent;
	...
	{		
        ...
        */
		...
		override protected function createChildren():void
		{
			...
			faceSkin  = createSkin( "faceSkin", GaugeSkin ); 
			addChild(DisplayObject(faceSkin));
			indicatorSkin = createSkin( "indicatorSkin", GaugeSkin ); 
			addChild(DisplayObject(indicatorSkin));
			indicatorCrownSkin  = createSkin( "indicatorCrownSkin", GaugeSkin );
			addChild(DisplayObject(indicatorCrownSkin));
			addChild(label); 
			highlightSkin  = createSkin( "highlightSkin", GaugeSkin ); 
